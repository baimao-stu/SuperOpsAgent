...
import com.whitec.service.AiOpsService;
import com.whitec.service.ChatService;
...
public class ChatController {
    ...
    public SseEmitter aiOps() {
        SseEmitter emitter = new SseEmitter(6000000L); // 10分钟超时（告警分析可能较慢）
...
//                                .withModel(DashScopeChatModel.DEFAULT_MODEL_NAME)
                ...
                if (finalReportOptional.isPresent()) {
                    ...
                    // 伪流式输出，finalReportOptional是一次性得出的
                    int chunkSize = 50;
